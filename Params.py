...
def parse_args():
    ...
    parser.add_argument('--use_ode_option', default="baseline", type=str, help='choose to run baseline or ODE model')
    ...
    parser.add_argument('--odeint_atol', default=1e-4, type=float, help='ode solver atol')
    parser.add_argument('--odeint_rtol', default=1e-3, type=float, help='ode solver rtol')
