...
with open('Datasets/CHI_crime_5km/CHI_Crime.csv', 'r') as fs:
	fs.readline()
	for line in fs:
...
for i in range(len(names)):
	with open('Datasets/CHI_crime_5km/' + names[i], 'wb') as fs:
...
with open('Datasets/CHI_crime_5km/metadata.json', 'w') as fs:
    json.dump(metadata, fs, indent=4)

with open('Datasets/CHI_crime_5km/metadata.pkl', 'wb') as fs:
